...
/*
 * Function: importTrainFiles
 * ----------------------------
 * Hàm đọc tập tin chứa dữ liệu huấn luyện
 */
{
 ...
 * ----------------------------
 * Hàm đọc tập tin chứa dữ liệu kiểm tra
 */
{
    FILE *fin;
    INT tmp;
...
/*
 * Function: importTypeFiles
 * ----------------------------
 * Hàm đọc tập tin chứa dữ liệu các ràng buộc về loại thực thể
 */
{
